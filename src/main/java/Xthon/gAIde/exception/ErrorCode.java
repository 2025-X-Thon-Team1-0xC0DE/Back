...
public enum ErrorCode {
    ...
    TOKEN_UNSUPPORTED("40102", HttpStatus.UNAUTHORIZED, "지원되지 않는 형식의 토큰입니다."),
  ...
  MEMBER_NOT_FOUND("40403", HttpStatus.NOT_FOUND, "존재하지 않는 계정입니다."),
